...
Then
   ...
   */
    ...
    public void get08(){
        ...
        System.out.println("idsGreaterThan190 = " + idsGreaterThan190);//10
        assertEquals(10,idsGreaterThan190);

        //2nd way:recommended
        List<Integer>intListGroovy=jsonPath.getList("findAll{it.id>190}.id");//groovy language:java based programming language
