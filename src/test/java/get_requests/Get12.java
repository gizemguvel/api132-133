...
public void get12() {
    ...
    //1st way: we will get all the genders in a list then we will count the number of females
    ...
    //2nd way: we will get all females inside the list by using groovy then compare it with males
